...
// [build] libkinesis_manager.so: undefined reference to `Aws::Client::ParameterPath::operator+(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> > const&) const'
